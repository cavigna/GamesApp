...
"Halo Infinite is the twelfth installment in the Halo franchise," +
...
" new Slipspace engine developed by Microsoft." +
...
"The game follows the series&#39; most famous protagonist: " +
"Master Chief, who is a “Spartan” - a genetically enhanced, power armor wearing super soldier." +
" Infinite continues the story of Master Chief and his companions, the Blue Team, as they fight" +
" against the AI called Cortana that tries to take over the control of the Halos." +
" AHalo Infinite is set on a forested Halo inhabited by rhinos and other wildlife reminiscent of prehistoric Earth." +
"In addition to single player story campaign, Halo Infinite supports cooperative multiplayer modes, both local and online."
